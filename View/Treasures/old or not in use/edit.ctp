...
<?php echo $this->Form->create('Treasure'); ?>
	<fieldset>
		<legend><?php echo __('Edit Treasure'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Treasure.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Treasure.id'))); ?></li>
