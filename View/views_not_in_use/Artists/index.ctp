<div class="artists index">
	...
	<div>
	<?php
	//echo $this->Html->link('TestLink', array(
    //'controller' => 'artists',
    //'action' => 'view/'.$artist['Artist']['id'].'/'.$artist['Artist']['slug']
    //'id' => $artist['Artist']['id'],
   // 'slug' => 'CakePHP_Rocks'
     echo $this->Html->link(__('SlugView'), array('action' => 'view2','s:'. $artist['Artist']['slug'])); ?>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $artist['Artist']['slug'])); ?>
