...
//lloyd commented out the line for the title, because...well why the hell do u want to title a comment?!
//echo $this->Form->input('Comment.title');
//seth added for argusid
//in the end, I decided to use a beforeSave instead afterall. The hidden value is too easy to futz with
//if(!empty($treasure['Treasure']['oldid'])) $argusid=$treasure['Treasure']['oldid'];
//else $argusid=null;
//echo $this->Form->input('Comment.argusid',array('value'=>$argusid,'type'=>'hidden'));
